        ...
        *               }
        ...
        value: function spreader(proc, resolve, project) {
            ...
            proc.on('close', function (code) {
                ...
                var percentage = _this3.options[project.executionType].completedCount / _this3.options[project.executionType].projects.length * 100;
                var output = {
                    type: 'done',
                    project: project,
                    projects: _this3.options[project.executionType].projects,
        ...
        key: 'executeScripts',
        value: async function executeScripts(type, resolver, rejector) {
            var groupType = this.options[type];
            this.rejector = rejector;
            if ((typeof groupType === 'undefined' ? 'undefined' : _typeof(groupType)) != 'object' || !groupType.projects || !groupType.projects.length) return resolver();
        ...
        value: function apply(compiler) {
            ...
            compiler.hooks.beforeCompile.tapPromise($plugin, function (compilation) {
                return new Promise(function (resolve, reject) {
                    _this5.executeScripts('onWebpackPre', resolve, reject);
                });
            });
            compiler.hooks.afterEmit.tapPromise($plugin, function (compilation, callback) {
                return new Promise(function (resolve, reject) {
                    _this5.executeScripts('onWebpackPost', resolve, reject);
                });
            });
            compiler.hooks.done.tapPromise($plugin, function () {
                return new Promise(function (resolve, reject) {
                    _this5.executeScripts('onWebpackDone', resolve, reject);
                });
            });
        }
    }]);
